...
export const WaitlistHero = () => {
  ...
  return (
    <div className="w-full min-h-[calc(100dvh-64px)] bg-black flex items-center justify-center">
      {/* Animation Styles */}
      <style>{`
        @keyframes spin-slow {
      ...
      {/* Main Container */}
      <div
        className="relative w-full h-[calc(100dvh-64px)] min-h-[600px] overflow-hidden shadow-2xl"
        style={{
      ...
      >
        ...
        <div className="relative z-20 w-full h-full flex flex-col items-center justify-center gap-6 px-4">
          ...
          >
            Get a free consultation from our 40-year veteran team.
          </p>
